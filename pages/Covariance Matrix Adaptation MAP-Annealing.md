...
## Main Contributions
	- Propose a new algorithm, [[CMA-MAE]] that smoothly blends between [[Covariance Matrix Adaptation Evolution Strategy]] and [[CMA-ME]] through a single parameter $\alpha$.
## Key Concepts